<!DOCTYPE html>
<!-- saved from url=(0087)http://www.baozupo.com/baozupo/web/houseDispatcher.do?method=showHouse&hsid=85&rmid=226 -->
<html lang="zh-cn"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <script type="text/javascript" src="public/admin/scripts/layer/layer.js"></script>
	...
	<![endif]-->
	<script src="public/desktop/js/video.js"></script>
	<script type="text/javascript">
	   videojs.options.flash.swf = "/baozupo/lib/video/video-js.swf";
	</script>
...
<body class="body-web" style="Overflow-y:scroll" cz-shortcut-listen="true">
<div class="header">
  ...
  <div style="overflow:hidden;width:100%;height:2px;background:url(images/topline.gif);"></div>
  
  <div style="height:10px;overflow:hidden;" width="100%"></div>
  
  <div class="div-box" style="min-height: 300px; height: 1926px; background-color: rgb(255, 255, 255);" id="content">
  
<!-- 主体 -->
<div style="width:100%">
  <input type="hidden" id="flag" name="flag" value="">
  <div class="div-left4" id="dLeft" style="position: absolute; top: 0px;">
	<table class="table_hsinfo" cellpadding="0" cellspacing="0" width="100%">
	  <tbody><tr class="td_line_hsinfo"><td></td></tr>
	  <tr><td>
	    <table class="table_hsinfo" width="100%">
	      <tbody><tr>
	        <td width="40px"><img src="public/desktop/images/money.gif"></td>
	  ...
	  <tr><td>
	    <table class="table_hsinfo" cellpadding="0" cellspacing="0" width="100%">
	      <tbody><tr class="td_line_hsinfo2"><td colspan="3"></td></tr>
    ...
    <table class="table" cellpadding="0" cellspacing="0" width="100%">
      <tbody><tr>
        ...
        <td width="10%" align="center">
          <table class="table_hsinfo" cellpadding="0" cellspacing="0" align="center">
            <tbody><tr>
              <td align="right">
                
                
              </td>
              <td align="left" style="color:#666666;" nowrap="">
         ...
         for($index=0;$index<count($imgs);$index++)
{
        ...
        <img class="img_slideLeft div_top" style="display:none" id="leftrpic" src="public/desktop/images/slideleft.png">
        <div class="div_slideLeft" onmousemove="showObj(&#39;leftrpic&#39;)" onmouseout="hiddenObj(&#39;leftrpic&#39;)" onclick="roomPicObj.loadRoomPic(-1,1,&#39;cls&#39;)"></div>
         ...
         for($index=0;$index<count($imgs);$index++)
{
        ...
        <img class="img_slideLeft div_top" style="display:none" id="leftapic" src="public/desktop/images/slideleft.png">
        <div class="div_slideLeft" onmousemove="showObj(&#39;leftapic&#39;)" onmouseout="hiddenObj(&#39;leftapic&#39;)" onclick="surPicObj.loadRoomPic(-1,1,&#39;cls&#39;)"></div>
...
<!--          <img id="apic0" src="public/desktop/images/yuan15_hs.png" class="handpoint" onclick="surPicObj.loadRoomPic(0,0,&#39;cls&#39;)">
    ...
    <div class="div_hsifor">
      ...
      <textarea style="width:690px;height:120px;" id="dsc" name="dsc" class="text_reg" onkeyup="statTxtFontNum(&#39;dsc&#39;,200)"></textarea>
      </div>
      <div class="div-split2"></div>
...
//  aPicArray.push("public/desktop/images/4.jpg");
  ...
  function roomPicSlide(picArrayN,parDivId,dotIdFro,picIdFro){
	  var interObj=null;//定时器对象
	  var slidingObj=new slidingPicture();//滚屏对象
	  var picArray=picArrayN;//图片数组
  	  var picN=-1;//当前图片序号
  	  var dotId=dotIdFro;//圆点图片id前缀
  	  var picId=picIdFro;//图片id前缀
  	  var that=this;
	  this.loadRoomPic=function(add,bz,interFlag){
		if(interFlag=="cls" || picArray.length<2){
			try{
				clearInterval(interObj);
			}catch(e){}
		}
	    if(picArray.length<1 || slidingObj.slideFlag){
	  		return;
	  	}
	    var oldN=picN;
	    picN=addNumForSlide(picN,add,bz,picArray.length);
	  	if(oldN==picN){
	  		return;
	  	}
	  	if(oldN>-1){
	  		document.getElementById(dotId+oldN).src="public/desktop/images/yuan15_ls.png";
	  	}
	  	document.getElementById(dotId+picN).src="public/desktop/images/yuan15_hs.png";
	  	if(slidingObj.imgIdbk){
	  		document.getElementById(slidingObj.imgIdbk).src=picArray[picN];
	  		if(bz==0){//点击
	  			slidingObj.slide(oldN-picN,30,1);
	  		}else{//左右移动
	  			slidingObj.slide(-add,30,1);
	  		}
	  	}else{
	  		document.getElementById(picId).src=picArray[picN];
	  	}
	  }
	  //加载默认图片
	  that.loadRoomPic(0);
	  //加载滑屏事件
	  interObj=slidingObj.bindEvent(parDivId, function(add,bz){that.loadRoomPic(add,bz);} ,picId,3000);
	  //interObj=bindEvent("surroundPicDiv",loadRoomPic);//图片直接替换模式
  }
  
  var oldAnchor="";
  function showAnchor(id){
    if(oldAnchor!=""){
    	document.getElementById(oldAnchor+"Tr").className="td_cont_hsinfo_l";
	    document.getElementById(oldAnchor+"A").className="font_nom";
	    document.getElementById(oldAnchor+"Right").src="public/desktop/images/right_hs.gif";
	    var src=document.getElementById(oldAnchor+"Img").src;
	    src=src.replace("_bs.gif","_hs.gif");
	  	document.getElementById(oldAnchor+"Img").src=src;
    }
    if(id!=""){
	    document.getElementById(id+"Tr").className="td_cont_hsinfo_lh";
	    document.getElementById(id+"A").className="font_nom_b";
	    document.getElementById(id+"Right").src="public/desktop/images/right_bs.gif";
	    var src=document.getElementById(id+"Img").src;
	    src=src.replace("_hs.gif","_bs.gif");
  ...
  //设置父容器的高度--在评论中调用
  var parCallFun=function(){
	  try{
	  	var h=fnPageY(document.getElementById("bottomSplitDiv"));
		setContentHeight(h);
	  }catch(e){
