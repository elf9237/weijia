...
<div id="regdiv" style="position:relative;background-color:#FFFFFF;">
  ...
  <div>
  	<table cellpadding="0" cellspacing="0" class="table" width="100%">
		<tbody><tr height="249px">
			<td width="250px" style="background-color:#34C4E6"><img src="public/desktop/images/eavesactive.png"></td>
			
			  
			  
			  
			  		<td width="250px" onclick="showparty(&#39;13&#39;)" class="handpoint" style="position:relative;">
				
				  
				  
				  	<img src="public/desktop/images/picmain1.jpg" class="images">
				  
				
					<div class="div_eaves" style="position:absolute;bottom:0px;">
				  	&nbsp;包租婆2016时尚生活秀&nbsp;|&nbsp;473人报名<br>
				  	&nbsp;[包租婆2016时尚生活秀]&nbsp;751D.PARK 第一车间
				  	</div>
					</td>
			  		...
			  		<td width="250px" onclick="showparty(&#39;11&#39;)" class="handpoint" style="position:relative;">
				
				  
				  
				  	<img src="public/desktop/images/picmain1(1).jpg" class="images">
					...
					<div class="div_eaves" style="position:absolute;bottom:0px;">
			  		...
			  		<td width="250px" onclick="showparty(&#39;10&#39;)" class="handpoint" style="position:relative;">
				
				  
				  
				  	<img src="public/desktop/images/picmain1(2).jpg" class="images">
