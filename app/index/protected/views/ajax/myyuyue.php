...
<div style="position:relative;background-color:#FFFFFF;">
  <table cellpadding="0" cellspacing="0" class="table" width="100%">
  	...
  	<tr height="125px">
  		...
  		<td width="200px" class="tdbord_ser1 handpoint" onclick="changeSerBk(1)" id="mybooktd" style="background-color: rgb(26, 188, 156);"><img id="mybookimg" src="public/desktop/images/mybook_y.png"></td>
