...
<div id="regdiv" style="position:relative;background-color:#FFFFFF;">
  <table cellpadding="0" cellspacing="0" class="table" width="100%">
  	...
  	<tr>
  		...
  		<td width="25%" id="paytd"   class="td_ser2" style="border-bottom:1px solid #F1F1F1;cursor:pointer;" align="center">
  			 <a  onclick="changeGuanJia(3)"><img id="payimg" src="public/desktop/images/problem_b.png"></a><br><br>
  	...
  	<tr>
  		<td height="250px"><img src="public/desktop/images/day7-03.png"></td>
