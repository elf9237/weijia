...
<div style="width:85%" class="div-center0">
                 <div class="myHouse-head clearfix">
              <h3 class="myHouse-title">我的房源</h3>
              <a class="addHouse" href="index.php?r=ajax/addmyhome">添加房源</a>
            </div>
              <div class="myHouse">
                <table class="table">
                  <thead>
                  ...
                  <tbody id="myhome">
                    ...
                    <tr>
                      ...
                      <td>福州</td>
                      <td class="onCao"><a href="#">修改</a><a href="#">置顶</a></td>
                    </tr>
                    <tr>
                      <th scope="row">3</th>
                      <td><img src="images/leaser32.jpg" alt="" width="200px" height="100px"></td>
...
<div style="height:32px;text-align:right;" id="turnPageBarhome">
</div>

</div>
      <h3 class="myHouse-title">已租房子</h3>
              <div class="myHouse">
                <table class="table">
                  <thead>
                    <tr>
            ...
            $.ajax({
               ...
               success:function(data){
                   ...
                   if(data.pageList.length>0){
                    ...
                    $("#myhome").html(innerHtml.join(""));
                   pageding($("#turnPageBarhome"),"queryMyhome",data);
