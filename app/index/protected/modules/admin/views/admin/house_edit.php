...
<head>
    ...
    <script src="public/admin/scripts/My97DatePicker/WdatePicker.js" type="text/javascript" defer="defer"></script>
        ...
        <div id="nav_links">
            ...
            <div id="page_close">
                <a href="javascript:parent.$.fancybox.close();">
                    <img src="public/admin/images/common/page_close.png" width="20" height="20"
