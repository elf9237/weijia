    ...
    <script type="text/javascript">
        ...
        function loadMenu(resourceType, treeObj) {
            ...
            data = [{
                ...
                {
                    "accessPath": "index.php?r=admin/default/houselist",
                    "checked": false,
                    "delFlag": 0,
                    "parentID": 3,
                    "resourceCode": "",
                ...
                {
                    "accessPath": "index.php?r=admin/default/chart",
                    "checked": false,
                    "delFlag": 0,
                    "parentID": 3,
                    "resourceCode": "",
    ...
    <div id="left_menu">
        <ul id="TabPage2" style="height:200px; margin-top:50px;">
            <li id="left_tab1" class="selected" onClick="javascript:switchTab('TabPage2','left_tab1');" title="业务模块">
                <img alt="业务模块" title="业务模块" src="public/admin/images/common/1_hover.jpg" width="33" height="31">
            </li>
            <li id="left_tab2" onClick="javascript:switchTab('TabPage2','left_tab2');" title="系统管理">
                <img alt="系统管理" title="系统管理" src="public/admin/images/common/2.jpg" width="33" height="31">
            </li>
            <li id="left_tab3" onClick="javascript:switchTab('TabPage2','left_tab3');" title="其他">
                <img alt="其他" title="其他" src="public/admin/images/common/3.jpg" width="33" height="31">
            </li>
        </ul>
        ...
        <div id="nav_show" style="position:absolute; bottom:0px; padding:10px;">
            <a href="javascript:;" id="show_hide_btn">
                <img alt="显示/隐藏" title="显示/隐藏" src="public/admin/images/common/nav_hide.png" width="35" height="35">
            </a>
        </div>
    </div>
...
<div id="main">
    <iframe name="right" id="rightMain" src="index.php?r=admin/default/introduce" frameborder="no" scrolling="auto"
